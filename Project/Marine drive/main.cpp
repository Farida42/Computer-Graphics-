...
void tree()
{
    ...
    // sndPlaySound("H:\\IIUC\\7th sem\\music\\day.wav", SND_ASYNC);
...
void information(void)
{
    ...
    if (!cover)
    {
        ...
        glColor3f(1.0,0.0,0.0);
        renderBitmapString(-0.3f,0.91f, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "MARINE DRIVE COX BAZAR");
        renderBitmapString(-0.14,0.86, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "Computer Graphics [L]");
        ...
        renderBitmapString(-0.84,0.7, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "  ");
        renderBitmapString(-0.22, 0.7, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, " ");
        renderBitmapString(0.74, 0.7, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, " ");

        renderBitmapString(-0.84,0.65, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "C201224 ");
        renderBitmapString(-0.22, 0.65, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Sabrina Mostary");
        renderBitmapString(0.74, 0.65, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "40");

        renderBitmapString(-0.84, 0.6, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "C201242");
        renderBitmapString(-0.22, 0.6, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Farida Nusrat");
        renderBitmapString(0.74, 0.6, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "60");

        renderBitmapString(-0.1,0.4, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Submitted to :");
        renderBitmapString(-0.13,0.35, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "     Israt Jahan");
        ...
        renderBitmapString(-0.23,0.2, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "            Faculty of Science ");
        renderBitmapString(-0.34,0.15, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, " International Islamic University-Chittagong(IIUC)");
        glFlush();
    }
...
void Input(unsigned char key, int x, int y)
{
    ...
    case 'd':
        night = false;
        //sndPlaySound("C:\\Users\\DELL\\Downloads\\Computer-Graphics-main.zip\\Computer-Graphics-main\\OpenGL Programming\\opengl-computer-graphics-project-main\\opengl-computer-graphics-project-main\\CGPROJECT\\music\\day.wav", SND_ASYNC);
        break;
    ...
    case 'r':
        rain = true;
        //sndPlaySound("C:\\Users\\DELL\\Downloads\\Computer-Graphics-main.zip\\Computer-Graphics-main\\OpenGL Programming\\opengl-computer-graphics-project-main\\opengl-computer-graphics-project-main\\CGPROJECT\\music\\rain.wav", SND_ASYNC);
        break;
